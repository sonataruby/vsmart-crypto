...
var OpenForBattle = {
  preload: function () {
    game.load.image("challengeothersbutton", "./game/car/images/challengeothersbutton.png");
    game.load.image("checkwinnerbutton", "./game/car/images/checkwinnerbutton.png");
    game.load.image("openforbattlebg", "./game/car/images/openforbattlebg.png");
    game.load.image(
      "homebutton",
