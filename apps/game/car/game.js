...
var Game = {
  preload: function () {
    game.load.spritesheet("map2", "./game/car/images/map2.jpg");
    game.load.image(
      "car",
      `./game/car/images/cars/${carLevelWithColor[selectedCar.level]}.png`
    );
    game.load.spritesheet("building", "./game/car/images/building.png");
    game.load.physics("collision", "./game/car/collision.json");
    game.load.image("trigger", "./game/car/images/trigger1.png");
